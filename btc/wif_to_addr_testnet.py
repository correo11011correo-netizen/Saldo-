...
def b58decode_check(s):
    ...
    full = num.to_bytes(50, "big")  # tamaño grande, luego recortamos
    # quitar ceros a la izquierda
    full = full.lstrip(b"\x00")
    # manejar leading '1's (ceros en binario)
    pad = 0
    for ch in s:
        if ch == "1":
            pad += 1
...
if len(sys.argv) != 2:
    print("Uso: python3 wif_to_addr_testnet.py <WIF>")
    sys.exit(1)
...
if version != 0xEF:
    print("No es WIF testnet, versión:", hex(version))
    sys.exit(1)
